...
public class RoleDAO {
    ...
    public RoleDAO(Integer id) {
        this.map(id);
    }

    public RoleDAO(String discordId) {
        this.mapByDiscordId(discordId);
    }

    public RoleDAO(String discordId, String name) {
    ...
    public void mapByDiscordId(String discordId) {
        ...
        try {
            String sql = "SELECT * FROM role WHERE discordId = ?";
    ...
    public void insert() {
        ...
        try {
            String sql = "INSERT INTO role (discordId,name) VALUES (?,?)";
    ...
    public void update() {
        ...
        try {
            String sql = "UPDATE role SET discordId = ?, name = ?, modified=?";
